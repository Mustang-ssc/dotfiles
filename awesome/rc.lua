...
--awful.util.tagnames = { "www", "edit", "telegram-desktop", "excel", "music" }
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F3", function () awful.util.spawn( "excel" ) end,
        {description = "excel" ,group = "function keys" }),
    awful.key({ modkey }, "F4", function () awful.util.spawn( "telegram-desktop" ) end,
        {description = "telegram-desktop" , group = "function keys" }),
